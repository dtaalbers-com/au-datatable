System.register(["aurelia-framework"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, AuTableSort;
    return {
        setters: [
        ...
        execute: function () {
            AuTableSort = /** @class */ (function () {
                function AuTableSort(element) {
                ...
                AuTableSort.prototype.attached = function () {
                    var _this = this;
                ...
                AuTableSort.prototype.sort = function (event) {
                ...
                AuTableSort.prototype.set_active = function (target, direction) {
                    this.reset();
                ...
                AuTableSort.prototype.reset = function () {
                    var _this = this;
                ...
                AuTableSort.prototype.get_index = function (target) {
                    if (target.nodeName == 'SPAN')
                        target = target.parentNode.closest('th');
                ...
                ], AuTableSort.prototype, "on_sort", void 0);
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTableSort.prototype, "columns", void 0);
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTableSort.prototype, "active_color", void 0);
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTableSort.prototype, "inactive_color", void 0);
                __decorate([
                    aurelia_framework_1.bindable({
                        defaultBindingMode: aurelia_framework_1.bindingMode.twoWay,
                    })
                ], AuTableSort.prototype, "parameters", void 0);
                AuTableSort = __decorate([
                    aurelia_framework_1.customAttribute('au-table-sort')
                ], AuTableSort);
                return AuTableSort;
            }());
            exports_1("AuTableSort", AuTableSort);
        }
    };
});
