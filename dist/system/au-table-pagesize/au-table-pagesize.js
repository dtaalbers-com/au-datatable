System.register(["aurelia-framework"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, AuTablePagesize;
    return {
        setters: [
        ...
        execute: function () {
            AuTablePagesize = /** @class */ (function () {
                function AuTablePagesize() {
                }
                AuTablePagesize.prototype.bind = function () {
                ...
                AuTablePagesize.prototype.page_size_change = function () {
                ...
                AuTablePagesize.prototype.reset = function () {
                    this.parameters.current_page = this.parameters.total_records > 0 ? 1 : 0;
                    this.parameters.skip = 0;
                };
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTablePagesize.prototype, "page_sizes", void 0);
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTablePagesize.prototype, "classes", void 0);
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTablePagesize.prototype, "on_page_size_change", void 0);
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTablePagesize.prototype, "parameters", void 0);
                AuTablePagesize = __decorate([
                    aurelia_framework_1.customElement('au-table-pagesize')
                ], AuTablePagesize);
                return AuTablePagesize;
            }());
            exports_1("AuTablePagesize", AuTablePagesize);
        }
    };
});
