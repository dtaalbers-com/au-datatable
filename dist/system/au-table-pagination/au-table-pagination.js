System.register(["aurelia-framework"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, AuTablePagination;
    return {
        setters: [
        ...
        execute: function () {
            AuTablePagination = /** @class */ (function () {
                function AuTablePagination(binding_engine) {
                    this.binding_engine = binding_engine;
                    this.amount_of_pages = 2;
                    this.refreshing = false;
                    this.subscriptions = [];
                }
                AuTablePagination.prototype.attached = function () {
                    var _this = this;
                ...
                AuTablePagination.prototype.data_change = function () {
                ...
                AuTablePagination.prototype.next_page = function () {
                ...
                AuTablePagination.prototype.previous_page = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        var response;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                ...
                AuTablePagination.prototype.change_page = function (page) {
                    return __awaiter(this, void 0, void 0, function () {
                        var response;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                ...
                AuTablePagination.prototype.calculate_previous_page_number = function (index) {
                    var number = (this.parameters.current_page + index) - this.amount_of_pages;
                    return number == 0 ? 1 : number;
                };
                AuTablePagination.prototype.detached = function () {
                    this.subscriptions.forEach(function (x) { return x.dispose(); });
                };
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTablePagination.prototype, "amount_of_pages", void 0);
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTablePagination.prototype, "on_next_page", void 0);
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTablePagination.prototype, "on_previous_page", void 0);
                __decorate([
                    aurelia_framework_1.bindable
                ], AuTablePagination.prototype, "on_page_change", void 0);
                __decorate([
                    aurelia_framework_1.bindable({
                        defaultBindingMode: aurelia_framework_1.bindingMode.twoWay,
                    })
                ], AuTablePagination.prototype, "parameters", void 0);
                AuTablePagination = __decorate([
                    aurelia_framework_1.autoinject(),
                    aurelia_framework_1.customElement('au-table-pagination')
                ], AuTablePagination);
                return AuTablePagination;
            }());
            exports_1("AuTablePagination", AuTablePagination);
        }
    };
});
